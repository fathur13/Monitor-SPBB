                        ...
                        <div class="row" style="max-width: 100%; margin: 0 auto;">
                            <div class="col-md-6">
                                <div
                                    ...
                                    <h4 style="margin: 0; font-size: 36px; font-weight: bold; color: #0D99FF;">Suhu</h4>
                                    <div
                                        style="display: flex; justify-content: center; align-items: center; flex-direction: column; height: 100%;">
                                        <span id="suhu" style="font-size: 124px; font-weight: bold;"></span>
