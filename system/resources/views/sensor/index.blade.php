...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/core-hr.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Mar 2023 12:48:26 GMT -->
<head>
    <meta charset="utf-8">
	...
	<link href="{{ url('public/assets') }}/cdn.datatables.net/buttons/1.6.4/css/buttons.dataTables.min.css" rel="stylesheet">
	<!-- Clockpicker -->
...
<body>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ url('public/assets') }}/images/avatar/1.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ url('public/assets') }}/images/avatar/2.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ url('public/assets') }}/images/avatar/3.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ url('public/assets') }}/images/avatar/4.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ url('public/assets') }}/images/avatar/5.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{ url('public/assets') }}/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{ url('public/assets') }}/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
											...
											<li>
												<div class="timeline-panel">
													<div class="media me-2">
														<img alt="image" width="50" src="{{ url('public/assets') }}/images/avatar/1.jpg">
													</div>
									...
									<div class="dropdown-menu dropdown-menu-end" style="">
										<div class="card border-0 mb-0">
											<div class="card-header py-2">
												<div class="products">
													<img src="{{ url('public/assets') }}/images/tab/1.jpg" class="avatar avatar-md" alt="">
													<div>
														<h6>Thomas Fleming</h6>
											...
											<table id="empoloyees-tbl" class="table">
												...
												<tbody>
													<tr>
														...
														<td>
															<div class="products">
																<img src="{{ url('public/assets') }}/images/contacts/pic2.jpg" class="avatar avatar-md" alt="">
																<div>
																	<h6>Moni Antony</h6>
																	<span>Web Designer</span>	
																</div>	
													...
													<tr>
														...
														<td>
															<div class="products">
																<img src="{{ url('public/assets') }}/images/contacts/pic1.jpg" class="avatar avatar-md" alt="">
																<div>
																	<h6>Joney Antony</h6>
																	<span>Web Designer</span>	
																</div>	
													...
													<tr>
														...
														<td>
															<div class="products">
																<img src="{{ url('public/assets') }}/images/contacts/pic3.jpg" class="avatar avatar-md" alt="">
																<div>
																	<h6>Peter Oliver</h6>
																	<span>Web Designer</span>	
																</div>	
    ...
    ***********************************-->
	...
	<!-- Dashboard 1 -->
	<script src="{{ url('public/assets') }}/js/dashboard/core-hr.js"></script>
	...
	<script src="{{ url('public/assets') }}/vendor/dropzone/dist/dropzone.js"></script>
	<!-- Apex Chart -->
...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/core-hr.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Mar 2023 12:48:27 GMT -->
</html>